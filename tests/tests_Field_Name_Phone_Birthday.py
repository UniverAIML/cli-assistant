...
from address_book.base_field_classes import Birthday, Field, Name, Phone
from address_book.class_birthday_managment import BirthdayManagementMixin
...
def test_field_rejects_non_string():
    with pytest.raises(TypeError):
        Field(123)  # type: ignore  # This should raise TypeError for non-string
...
def test_add_birthday_valid():
    ...
    assert obj.birthday is not None
