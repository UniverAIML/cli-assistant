...
class ShowContactsCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        if contacts:
            return FunctionResult(
                True, 
                f"📞 Here are all your contacts ({len(contacts)} total)",
                contacts
            )
        else:
            return FunctionResult(
...
class EditContactCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        return FunctionResult(
            True, 
            f"✅ Successfully edited contact: {name} (action: {action})"
        )
...
class DeleteContactCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        return FunctionResult(
            True, 
            f"✅ Successfully deleted contact: {name}"
        )
...
class ViewContactDetailsCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        return FunctionResult(
            True, 
            f"📞 Showing details for contact: {name}"
        )
...
class ShowNotesCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        if notes:
            return FunctionResult(
                True,
                f"📝 Here are all your notes ({len(notes)} total)",
                notes
            )
        else:
            return FunctionResult(
...
class EditNoteCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        return FunctionResult(
            True,
            f"✅ Successfully edited note: {note_id} (action: {action})"
        )
...
class DeleteNoteCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        return FunctionResult(
            True,
            f"✅ Successfully deleted note: {note_id}"
        )
...
class ViewNoteDetailsCommand(BaseCommand):
    ...
    def _execute_operation(self) -> FunctionResult:
        ...
        return FunctionResult(
            True,
            f"📝 Showing details for note: {note_id}"
        )
...
class FunctionExecutor:
    ...
    def register_command(self, function_name: str, command_class: type[BaseCommand]) -> None:
